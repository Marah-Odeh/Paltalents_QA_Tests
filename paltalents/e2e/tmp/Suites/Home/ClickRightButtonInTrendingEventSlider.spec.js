...
describe('Click right button in Trending Event', () => {
    ...
    it('should click right button in Trending Event slider ', () => __awaiter(void 0, void 0, void 0, function* () {
        let rightbutt = yield HomePage_locator_1.HomePageLocators.RightButtonInTrendingEvent;
        expect(yield rightbutt.isDisplayed()).toBe(true);
