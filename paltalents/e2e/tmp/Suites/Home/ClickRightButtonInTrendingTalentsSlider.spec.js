...
describe('Click right button in Trending Talents', () => {
    ...
    it('should click right button in Trending Talents slider ', () => __awaiter(void 0, void 0, void 0, function* () {
        let Trightbutt = yield HomePage_locator_1.HomePageLocators.RightButtonInTrendingTalents;
        expect(yield Trightbutt.isDisplayed()).toBe(true);
