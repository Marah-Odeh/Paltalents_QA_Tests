...
describe('Hover image in Trending Talents', () => {
    ...
    it('should hover image in Trending-Talents ', () => __awaiter(void 0, void 0, void 0, function* () {
        let image = yield HomePage_locator_1.HomePageLocators.AreinImage;
        expect(yield image.isDisplayed()).toBe(true);
